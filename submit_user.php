...
$postData = array("user_name" => $username,'email_id' => $email_id,'mobile_no'=>$mobile,'password'=>$password,'address'=>$address,'city'=>$city,'enroll_date'=>$a,'enroll_end_date'=>$b,'users_type'=>$usertype,'pincode'=>$pincode);
